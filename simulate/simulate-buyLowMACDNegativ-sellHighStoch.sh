...
echo "<!DOCTYPE html><html lang='en'><head><meta charset='utf-8' /><link rel='icon' type='image/x-icon' href='favicon.ico' /><script type='text/javascript' src='_result.js' async></script><title>Simulate</title></head><body>" >> $OUT_SIMULATE_FILE
