...
# Call example: simulate/simulate-buyLowMACDNegativ-sellHighStoch.sh 'BEI' 3000 25 70 1.1 99 2 7 5
# Call example: simulate/simulate-buyLowMACDNegativ-sellHighStoch.sh 'BEI HLE GZF TNE5' 3000 25 91 1.1 99 1 7 5
# Call example: simulate/simulate-buyLowMACDNegativ-sellHighStoch.sh 'BEI HLE GZF TNE5' 3000 25 65 1.01 99 2 7 5
...
Out "Symbols ($countSymbols):$SYMBOLS_PARAM_SHORTEND" $OUT_SIMULATE_FILE
...
{       
    ...
    echo "<br><a href=\"https://htmlpreview.github.io/?https://github.com/Hefezopf/stock-analyse/blob/main/$SIM_LAST_ALARMS_HTML_FILE\" target=\"_blank\">Screen Last Alarms</a><br>"    
