...
# Call: simulate/simulate-buyRSILowDivergent-sellHighStoch.sh SYMBOL AMOUNT_PER_TRADE RSI_BUY_LEVEL STOCH_SELL_LEVEL INCREMENT_PER_TRADE
...
# Call example: simulate/simulate-buyRSILowDivergent-sellHighStoch.sh 'BEI ALV' 2000 25 91 1.1
# Call example: simulate/simulate-buyRSILowDivergent-sellHighStoch.sh 'BEI HLE GZF TNE5' 2000 25 91 1.1
...
creationHourOffset=
if [ "$(uname)" = 'Linux' ]; then
    creationHourOffset=" +2h"
fi
echo "Good Luck! Donate? $creationDate$creationHourOffset" | tee -a $OUT_SIMULATE_FILE
