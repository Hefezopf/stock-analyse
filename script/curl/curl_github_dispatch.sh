...
# POST Request to run action in GitHub
# Call: ./curl_github_dispatch.sh SYMBOLS PERCENTAGE QUERY STOCHASTIC RSI
# Call example: ./script/curl/curl_github_dispatch.sh "CEC" 1 offline 9 30
# Call example: ./script/curl/curl_github_dispatch.sh "*GIS" 1 offline 9 30
