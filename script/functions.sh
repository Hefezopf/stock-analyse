...
WriteComdirectUrlAndStoreFileList() {
    ...
    if [ ! "$_id_notation" = "$ID_NOTATION_STORE_FOR_NEXT_TIME" ]; then
        ...
        {
            # Hover Chart           
            echo "<img border='1' id='imgToReplace$_symbolParam' alt='' loading='lazy' src='https://charts.comdirect.de/charts/rebrush/design_big.chart?AVG1=95&AVG2=38&AVG3=18&AVGTYPE=simple&IND0=SST&IND1=RSI&IND2=MACD&LCOLORS=5F696E&TYPE=MOUNTAIN&LNOTATIONS=$_id_notation&TIME_SPAN=10D' style='display:none;position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);'/>"
#            echo "<img border='1' id='imgToReplace$_symbolParam' alt='' loading='lazy' src='https://charts.comdirect.de/charts/rebrush/design_big.chart?AVG1=95&AVG2=38&AVG3=18&AVGTYPE=simple&IND0=RSI&LCOLORS=5F696E&TYPE=MOUNTAIN&LNOTATIONS=$_id_notation&TIME_SPAN=10D' style='display:none;position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);'/>"
            ...
            echo "<a style='color:$_linkColorParam' onmouseover=\"javascript:showChartImage('6M', '$_symbolParam')\" onmouseout=\"javascript:hideChartImage('$_symbolParam')\" href='$COMDIRECT_URL_PREFIX_6M$_id_notation' target='_blank'>&nbsp;6M&nbsp;</a>"
            echo "<a style='color:$_linkColorParam' onmouseover=\"javascript:showChartImage('5Y', '$_symbolParam')\" onmouseout=\"javascript:hideChartImage('$_symbolParam')\" href='$COMDIRECT_URL_PREFIX_5Y$_id_notation' target='_blank'>&nbsp;5Y&nbsp;</a>"
            echo "<a style='color:$_linkColorParam' href='https://htmlpreview.github.io/?https://github.com/Hefezopf/stock-analyse/blob/main/out/$_symbolParam.html' target='_blank'>&nbsp;SA&nbsp;</a>"
            echo "<a id='linkPC$_symbolParam' style='color:$_linkColorParam; display: none' href='D:/code/stock-analyse/out/$_symbolParam.html' target='_blank'>&nbsp;PC&nbsp;</a>"
            echo "</div>"
        } >> "$_outResultFileParam"
    fi
