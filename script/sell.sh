...
echo "<div style='font-size: x-large;'>&nbsp;$today&#9;$WIN_AMOUNT&#8364;&#9;$winPercentage%&#9;<a href='https://htmlpreview.github.io/?https://github.com/Hefezopf/stock-analyse/blob/main/out/$symbolParam.html' target='_blank'>$symbolParam&#9;\"$SYMBOL_NAME\"</a></div><br>" | tee -a "$TRANSACTION_HISTORY_FILE"
echo ""
