...
<script>
fetch(\"https://query1.finance.yahoo.com/v8/finance/chart/DBK.DE?interval=3mo\", {
...
var requestURL = 'https://query1.finance.yahoo.com/v8/finance/chart/DBK.DE?interval=3mo';
...
request.onload = function() {
  ...
  console.error('XXXXXXXXXXX'+superHeroes['regularMarketPrice']);
}
</script>
