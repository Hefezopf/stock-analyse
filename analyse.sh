...
#echo "--------lastRaw:$lastRaw"    
    ...
    rm -rf "$indexSymbolFile"
    {
        ...
        echo "<a $styleComdirectLink onmouseover=\"javascript:showChart('10D')\" onmouseleave='javascript:hideChart()' href=\"$COMDIRECT_URL_10D""$ID_NOTATION"\" " target=\"_blank\">$markerOwnStock$symbol $symbolName</a>"
        echo "<a $styleComdirectLink onmouseover=\"javascript:showChart('6M')\" onmouseleave='javascript:hideChart()' href=\"$COMDIRECT_URL_6M""$ID_NOTATION"\" " target=\"_blank\">&nbsp;6M&nbsp;</a>"
        echo "<a $styleComdirectLink onmouseover=\"javascript:showChart('5Y')\" onmouseleave='javascript:hideChart()' href=\"$COMDIRECT_URL_5Y""$ID_NOTATION"\" " target=\"_blank\">&nbsp;5Y&nbsp;</a>"
...
#echo "isPercentLastDayNegativ: $isPercentLastDayNegativ $_linkColor"
        ...
        echo "<a id='headlineLink$symbol' $styleComdirectLink onmouseover=\"javascript:showChart('10D')\" onmouseleave='javascript:hideChart()' href=\"$COMDIRECT_URL_10D""$ID_NOTATION"\" " target=\"_blank\">$markerOwnStock$symbol $symbolName</a>"
        echo "<a $styleComdirectLink onmouseover=\"javascript:showChart('6M')\" onmouseleave='javascript:hideChart()' href=\"$COMDIRECT_URL_6M""$ID_NOTATION"\" " target=\"_blank\">&nbsp;6M&nbsp;</a>"
        echo "<a $styleComdirectLink onmouseover=\"javascript:showChart('5Y')\" onmouseleave='javascript:hideChart()' href=\"$COMDIRECT_URL_5Y""$ID_NOTATION"\" " target=\"_blank\">&nbsp;5Y&nbsp;</a>"
        echo "&nbsp;&nbsp;<span style='font-size:50px; color:rgb(0, 0, 0)'><b>$last€</b></span>"
