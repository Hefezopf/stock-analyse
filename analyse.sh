...
echo "</span>" >> "$OUT_RESULT_FILE"
{
    ...
    echo "<button id='intervalSectionButtonOpenAll' style='font-size:large; height: 60px; width: 110px; display: none' disabled='disabled' type='button' onClick='javascript:doOpenAllInTab()'>OpenAll</button>"
