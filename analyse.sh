...
#echo "--------lastRaw:$lastRaw"    
    ...
    rm -rf "$indexSymbolFile"
    {
        ...
        echo "<a $styleComdirectLink onmouseenter=\"javascript:showChart('10D')\" onmouseleave='javascript:hideChart()' href=\"$COMDIRECT_URL_10D""$ID_NOTATION"\" " target=\"_blank\">$markerOwnStock$symbol $symbolName</a>"
        echo "<a $styleComdirectLink onmouseenter=\"javascript:showChart('6M')\" onmouseleave='javascript:hideChart()' href=\"$COMDIRECT_URL_6M""$ID_NOTATION"\" " target=\"_blank\">&nbsp;6M&nbsp;</a>"
        echo "<a $styleComdirectLink onmouseenter=\"javascript:showChart('5Y')\" onmouseleave='javascript:hideChart()' href=\"$COMDIRECT_URL_5Y""$ID_NOTATION"\" " target=\"_blank\">&nbsp;5Y&nbsp;</a>"
...
#echo "isPercentLastDayNegativ: $isPercentLastDayNegativ $_linkColor"
        ...
        echo "<a id='headlineLink$symbol' $styleComdirectLink onmouseenter=\"javascript:showChart('10D')\" onmouseleave='javascript:hideChart()' href=\"$COMDIRECT_URL_10D""$ID_NOTATION"\" " target=\"_blank\">$markerOwnStock$symbol $symbolName</a>"
        echo "<a $styleComdirectLink onmouseenter=\"javascript:showChart('6M')\" onmouseleave='javascript:hideChart()' href=\"$COMDIRECT_URL_6M""$ID_NOTATION"\" " target=\"_blank\">&nbsp;6M&nbsp;</a>"
        echo "<a $styleComdirectLink onmouseenter=\"javascript:showChart('5Y')\" onmouseleave='javascript:hideChart()' href=\"$COMDIRECT_URL_5Y""$ID_NOTATION"\" " target=\"_blank\">&nbsp;5Y&nbsp;</a>"
        echo "&nbsp;&nbsp;<span style='font-size:50px; color:rgb(0, 0, 0)'><b>$last€</b></span>"
    ...
    if [ "$(uname -n)" != 'markus-ideacentre-700-25ISH' ]; then
...
#echo "isStocksPerformanceNegativ: $isStocksPerformanceNegativ $_linkColor"
        {
            ...
            echo "Delay: <span id='intervalSectionRegularMarketTimeOffset$symbol' style='font-size:large; display: none'></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input tabindex='0' name='intervalField$symbol' id='intervalField$symbol' type='text' style='height: 45px;' maxlength='3' size='3' value='10'/>&nbsp;<button type='button' id='intervalButton$symbol' style='font-size:large; height: 50px; width: 97px' onClick=\"javascript:setBeepInterval('$symbol')\">Minutes</button><span id='intervalText$symbol'></span>"
            echo "</span>"
